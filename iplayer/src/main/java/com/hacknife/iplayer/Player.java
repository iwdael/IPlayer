...
public abstract class Player extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    public static void goOnPlayOnResume() {
        if (PlayerManager.getCurrentVideo() != null) {
            ...
            if (player.currentState == Player.CURRENT_STATE_PAUSE) {
    ...
    public static void goOnPlayOnPause() {
        if (PlayerManager.getCurrentVideo() != null) {
            ...
            if (video.currentState == Player.CURRENT_STATE_AUTO_COMPLETE || video.currentState == Player.CURRENT_STATE_NORMAL || video.currentState == Player.CURRENT_STATE_ERROR) {
            } else {
