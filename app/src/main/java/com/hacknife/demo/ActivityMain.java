...
import com.hacknife.iplayer.UserAction;
import com.hacknife.iplayer.UserActionStd;
...
public class ActivityMain extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Video.setJzUserAction(new MyUserActionStd());
     ...
     */
    class MyUserActionStd implements UserActionStd {
        ...
        public void onEvent(int type, Object url, int screen, Object... objects) {
            switch (type) {
                ...
                case UserActionStd.ON_CLICK_START_THUMB:
                    Log.i("USER_EVENT", "ON_CLICK_START_THUMB" + " title is : " + (objects.length == 0 ? "" : objects[0]) + " url is : " + url + " screen is : " + screen);
                    break;
                case UserActionStd.ON_CLICK_BLANK:
