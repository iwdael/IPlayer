...
public class ActivityApiUISmallChange extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        jzvdStdWithShareButton.setDataSource(VideoConstant.videoUrlList[3], "饺子想呼吸", Player.SCREEN_WINDOW_NORMAL
        );
        Glide.with(this)
        ...
        jzvdStdShowTitleAfterFullscreen.setDataSource(VideoConstant.videoUrlList[4], "饺子想摇头", Player.SCREEN_WINDOW_NORMAL
        );
        Glide.with(this)
        ...
        jzvdStdShowTextureViewAfterAutoComplete.setDataSource(VideoConstant.videoUrlList[5], "饺子想旅行", Player.SCREEN_WINDOW_NORMAL
        );
        Glide.with(this)
        ...
        jzvdStdAutoCompleteAfterFullscreen.setDataSource(VideoConstant.videoUrls[0][1], "饺子没来", Player.SCREEN_WINDOW_NORMAL
        );
        Glide.with(this)
        ...
        jzvdStd_1_1.setDataSource(VideoConstant.videoUrls[0][1], "饺子有事吗", Player.SCREEN_WINDOW_NORMAL
        );
        Glide.with(this)
                .load(VideoConstant.videoThumbs[0][1])
        ...
        jzvdStd_16_9.setDataSource(VideoConstant.videoUrls[0][1], "饺子来不了", Player.SCREEN_WINDOW_NORMAL
        );
        Glide.with(this)
                .load(VideoConstant.videoThumbs[0][1])
        ...
        jzvdStdVolumeAfterFullscreen.setDataSource(VideoConstant.videoUrls[0][1], "饺子摇摆", Player.SCREEN_WINDOW_NORMAL
        );
        Glide.with(this)
                .load(VideoConstant.videoThumbs[0][1])
        ...
        jzvdStdMp3.setDataSource("https://in-20170815011809382-q34ludd68h.oss-cn-shanghai.aliyuncs.com/video/401edae1-16431aa8156-0007-1823-c86-de200.mp3?Expires=1532102862&OSSAccessKeyId=LTAIPZHZDaUNpnca&Signature=apruidffjNeN0O584VJiz8q1mJ4%3D",
                "饺子你听", Player.SCREEN_WINDOW_NORMAL
        );
        Glide.with(this)
                .load(VideoConstant.videoThumbs[0][1])
